...
function disp4() {
    if [[ $1 == 'aoc' ]];then
        xrandr --output DP-4 --auto --output eDP-1 --off
        return
    fi
    if [[ $1 == 'bjb' ]];then
        xrandr --output eDP-1 --auto --output DP-4 --off
        return
    fi
    if [[ $1 == 'all' ]];then
        xrandr --output DP-4 --auto --above eDP-1 --auto
        return
    fi
}
...
function disp3() {
    if [[ $1 == 'aoc' ]];then
        xrandr --output DP-3 --auto --output eDP-1 --off
        return
    fi
    if [[ $1 == 'bjb' ]];then
    ...
    if [[ $1 == 'all' ]];then
        xrandr --output DP-3 --auto --above eDP-1 --auto
        return
    fi
}
